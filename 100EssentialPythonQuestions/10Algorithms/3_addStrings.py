...
def solution(num1, num2):
    # eval(expression) the string parsed and evaluated as a python expression
    eval(num1) + eval(num2)
...
# Approach 2
# Given a string of length one, the ord() function returns an integer representing the Unicode code point of the character when the argument is a unicode object, or the value of the byte when the argument is an 8-bit string.
